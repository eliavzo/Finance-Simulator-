...
import { BuyoutsScreen } from './src/sim/screens/BuyoutsScreen';
        ...
        {!game || !game.started ? (
          ...
          <NavigationContainer theme={navTheme}>
            ...
            >
              ...
              <Tab.Screen name="Buyouts" component={BuyoutsScreen} options={{ tabBarIcon: ({ color }) => <TabGlyph glyph="⌂" color={color} /> }} />
